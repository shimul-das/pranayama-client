    ...
    const onSubmit = data => {
        ...
        .then(imgResponse => {
            if(imgResponse.success){
                ...
                const newItem = {className,instructorName:user.displayName,instructorEmail:user.email,availableSeats, price: parseFloat(price), image:imgURL,enrolledStudent:0,feedback:'', stauts:"pending"}
                console.log(newItem)
